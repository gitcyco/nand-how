...
var circuit_digital_gate_DIN40700_AND = CircuitFigure.extend({
  ...
  init: function (attr, setter, getter) {
    ...
    port = this.addPort(
      ...
      new draw2d.layout.locator.XYRelPortLocator({ x: 98.16960000000108, y: 50 })
    );
    ...
    port = this.addPort(
      ...
      new draw2d.layout.locator.XYRelPortLocator({ x: -0.4128000000018801, y: 21.25 })
    );
    ...
    port = this.addPort(
      new DecoratedInputPort(),
      new draw2d.layout.locator.XYRelPortLocator({ x: -0.4128000000018801, y: 80 })
    );
    port.setConnectionDirection(3);
    port.setBackgroundColor("#37B1DE");
    port.setName("input1");
