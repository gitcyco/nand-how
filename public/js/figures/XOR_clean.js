...
//
var XorClean = draw2d.SetFigure.extend({
  NAME: "XorClean",
  ...
  init: function (attr, setter, getter) {
    ...
    var port;
    // output
    port = this.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(100.86436350374439, 49.02567969069869));
    port.setConnectionDirection();
    port.setBackgroundColor("#37B1DE");
    port.setName("output");
    port.setMaxFanOut(20);
    // input2
    port = this.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(13.93940413740021, 70.59697875460611));
    port.setConnectionDirection();
    port.setBackgroundColor("#37B1DE");
    port.setName("input2");
    port.setMaxFanOut(20);
    // input1
    port = this.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(13.93940413740021, 27.454380626791263));
    port.setConnectionDirection();
    port.setBackgroundColor("#37B1DE");
    port.setName("input1");
    port.setMaxFanOut(20);
